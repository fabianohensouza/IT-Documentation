...
class BackupForm extends Page
{
    ...
    public function __construct()
    {
        ...
        $this->form->setTitle("{$coop} - Backup de dados");
        ...
        $provedor_nuvem->addItems(array("Azure" => "Azure",
                                        "AWS" => "AWS",
                                        "Outro" => "Outro"));
        $midia->addItems(array( "Fita LTO" => "Fita LTO",
        ...
        $sistema->placeholder = "Digite o nome do sistema de backup utilizado";
        ...
        $this->form->addField('Servidor OnPremisse',   $server_onprimisse, '70%');
        $this->form->addField('Provedor de Nuvem',   $provedor_nuvem, '70%');
        $this->form->addField('Sistema de backup',   $sistema, '70%');
        $this->form->addField('Midia de Armazenamento',   $midia, '70%');
