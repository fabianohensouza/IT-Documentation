...
class RateiosFormList extends Page
{
    ...
    public function __construct()
    {
        ...
        $periodo= new DatagridColumn('periodo',      'Período', 'center',   '20%');
        $valor_ic  = new DatagridColumn('valor_ic','Valor IC','center',   '20%');
        $valor_total  = new DatagridColumn('valor_total',        'Valor Total.',    'center',  '20%');
        $equipamentos    = new DatagridColumn('total_equip',    'Equipamentos',     'center',  '20%');
        ...
        $this->datagrid->addAction( 'Editar',  new Action([new RateiosForm, 'onEdit']), 'periodo', 'fa fa-edit fa-lg blue');
        $this->datagrid->addAction( 'Excluir', new Action([$this, 'onDelete']),          'periodo', 'fa fa-trash fa-lg red');
        $this->datagrid->addAction( 'Exibir rateio', new Action([new DocumentacaoReport, '']),          'id', 'far fa-file-alt fa-lg');
